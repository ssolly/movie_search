...
public class MovieSearchRestController {
	...
	/*
	 * @GetMapping("getMovies") public String getMovies() {
	 * System.out.println("search 연결 되었습니다"); return "성공"; }
	 */
	...
	/*
	 * @GetMapping("movieinfo/{movieId}") public Map<String, Object>
	 * movieInfo(@PathVariable String movieId) { Map<String, Object> map = new
	 * HashMap(); map.put("result", "success : " + movieId); return map; }
	 */
